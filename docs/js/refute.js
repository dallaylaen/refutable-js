    ...
    getLines(indent='') {
        ...
        for (let n = 1; n<=this._count; n++) {
            ...
            if( this._nested[n]) {
                ...
                out.push( ...this._evidence[n].map(
                    s => indent + '    '+(s.match(/^[-+^] /)?s:'^ '+s)) );
            };
            if (this._info[n])
