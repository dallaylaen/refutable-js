...
class Report {
     ...
     *  @param {integer} timeout   Promise will reject if timeout is reached.
    ...
    setResult (evidence, descr, condName, where) {
        ...
        if (evidence instanceof Promise) {
            ...
            evidence.then( x => {
                ...
                this._setResult(n, x, descr, condName, where );
                if (this.getDone()) {
